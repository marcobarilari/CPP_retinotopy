...
try
    ...
    for CurrAngle = 1:1:359
        ...
        for f = 1:size(Parameters.Stimulus, 3)
            ...
            % Screen('DrawTexture', Win, BgdTextures(f), StimRect, CenterRect(StimRect, Rect), ...
            % CurrAngle);
            %
            % Screen('Flip', Win);
            ...
            Screen('FillArc', AppTexture, [0 0 0 0], ...
                CenterRect([0 0 repmat(StimRect(4), 1, 2)], Rect), ...
                CurrAngle, Parameters.Apperture_Width);

            Screen('DrawTexture', Win, BgdTextures(f), StimRect, ...
                CenterRect(StimRect, Rect), CurrAngle);
            ...
            print(gcf, ...
                ['Checkerboard_' sprintf('%01.0f', f) ...
                '_Angle_' sprintf('%03.0f', CurrAngle) '.tif'], '-dtiff');
